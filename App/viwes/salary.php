...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">  شاشة  اضافة مستودع</h1>
    ...
    <form action="" method="post">
            <input type="hidden" name="csrftoken" value="124e4ce3b5251c2b4d12e9aaf2a3ddc620b">
                            <div class="form-group mb-3">
                                <label for="fname">عنوان المستودع  </label>
                                <input type="text" name="emploname" placeholder="  عنوان المستودع" class="form-control">
 <?php if(!empty($data['emploname_err'])){ echo'<span class="text-danger">'. $data['emploname_err'].'<span>';}?>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="start" placeholder="   نوع المستودع  "
                                    class="form-control" >                                  
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="end" placeholder="  رقم الهاتف     "
                                    class="form-control" >                                  
